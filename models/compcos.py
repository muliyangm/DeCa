...
class CompCos(nn.Module):
    ...
    def update_feasibility(self, epoch):
        ...
        self.feasibility_margin = min(1., epoch / self.epoch_max_margin) * (self.cosine_margin_factor * feasibility_scores.float().to(device))
    ...
    def train_forward_closed(self, x):
        ...
        pair_pred = torch.matmul(img_feats_normed, pair_embed)  # cos similarity
