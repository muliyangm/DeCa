...
def main():
    ...
    if name == 'temp':
        ...
        logpath = os.path.join(args.cv_dir, name)
    ...
    print('=======> cuDNN Benchmark: %s <========' % args.cudnn_benchmark)
    torch.backends.cudnn.benchmark = True if args.cudnn_benchmark else False
    print('=======> cuDNN Deterministic: %s <========' % args.cudnn_deterministic)
    torch.backends.cudnn.cudnn_deterministic = True if args.cudnn_deterministic else False

    # Get dataset
    trainset = dset.CompositionDataset(
        root=os.path.join(DATA_FOLDER, args.data_dir),
        phase='train',
        split=args.splitname,  # compositional-split-natural
