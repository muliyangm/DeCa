...
DATA_FOLDER = "/home/yml/dataset/czsl/"
parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)

parser.add_argument('--tsne', default=False, action='store_true', help='produce tsne visualization')

parser.add_argument('--seed', default=2021, type=int, help='random seed')
parser.add_argument('--cudnn_benchmark', default=True, type=bool, help='torch.backends.cudnn.benchmark')
parser.add_argument('--cudnn_deterministic', default=True, type=bool, help='torch.backends.cudnn.cudnn_deterministic')

parser.add_argument('--similarity', default='cos', help='cos|dot, cosine similarity or dot product')
parser.add_argument('--alpha', default=0.4, type=float, help='trade off in inference')
